  ...
  return (
    <div className="mt-8 flex flex-col sm:flex-row gap-4">
      <button
        ...
        className="w-full sm:flex-1 py-4 rounded-2xl bg-gradient-to-r from-[#D6405F] to-[#F23B69] text-white font-black text-[11px] uppercase tracking-widest shadow-lg hover:scale-[1.02] disabled:opacity-50 transition-all flex items-center justify-center order-1 sm:order-2"
      >
