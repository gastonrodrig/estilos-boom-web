    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white/70 dark:bg-black/50 backdrop-blur-2xl border border-[#EAE0E2] dark:border-white/10 rounded-[32px] w-full max-w-lg p-8 shadow-2xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-black text-[#40202D] dark:text-white tracking-wide">Prolongar Fecha</h2>
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-[10px] font-black text-[#8C6B79] dark:text-gray-400 uppercase tracking-widest mb-2">Nueva Fecha de Entrega</label>
            <input
              type="date"
              value={newDate}
          ...
          <div>
            <label className="block text-[10px] font-black text-[#8C6B79] dark:text-gray-400 uppercase tracking-widest mb-2">Motivo de la Extensión</label>
            <textarea
              value={reason}
        ...
        <div className="mt-8 flex flex-col gap-4">
          <button
            ...
            className="w-full py-4 rounded-2xl bg-amber-500/90 text-white font-black text-[11px] uppercase tracking-widest flex items-center justify-center gap-3 transition-all shadow-lg hover:scale-[1.02] disabled:opacity-50"
          >
