      ...
      {showButton && (
        <>
          <button
            ...
            className="mt-5 w-full rounded-sm bg-[#F2778D] px-4 py-3 text-[12px] font-bold uppercase tracking-wide text-[#FAF9F6] shadow-sm transition hover:bg-[#F291A3] hover:cursor-pointer"
          >
