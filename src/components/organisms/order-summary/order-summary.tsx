  ...
  return (
    <aside className="sticky top-28 rounded-2xl border border-[#F2D0D3] bg-white p-6 shadow-[0_2px_16px_rgba(89,66,70,0.08)]">
      ...
      <button
        ...
        className="mt-6 w-full rounded-xl bg-[#F2778D] px-4 py-3 text-sm font-bold uppercase tracking-wide text-[#FAF9F6] shadow-sm transition hover:bg-[#F291A3] hover:cursor-pointer"
      >
        {isAuthenticated ? "Proceder al pago" : "Inicie sesión para continuar"}
      </button>

      <p className="mt-2 text-center text-xs font-medium text-[#594246]/55">
