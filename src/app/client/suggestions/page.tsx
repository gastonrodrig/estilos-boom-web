                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full bg-[#FAF9F6] dark:bg-white/5 border border-[#EBEAE8] dark:border-[#e8688a]/30 rounded-2xl px-5 py-4 text-[#632034] dark:text-[#f8f0f5] font-medium appearance-none focus:outline-none focus:ring-2 focus:ring-[#F2D0D3] dark:focus:ring-[#e8688a]/50 focus:border-[#F2D0D3] dark:focus:border-[#e8688a]/50 transition-all shadow-inner cursor-pointer"
                      >
                        <option value="" disabled className="dark:bg-[#2d0a1e] dark:text-[#f0d8e8]">Selecciona un producto de la lista...</option>
                        {MOCK_PRODUCTS.map(prod => (
                          <option key={prod} value={prod} className="dark:bg-[#2d0a1e] dark:text-[#f8f0f5]">{prod}</option>
                        ))}
                      </select>
                      <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 w-5 h-5 text-[#594246]/40 dark:text-[#f0d8e8]/40 pointer-events-none" />
                    </div>
                  </div>
                )}
