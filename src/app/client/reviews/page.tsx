  ...
  return (
    <div className="relative space-y-8 w-full pb-10 min-h-[80vh]">
      ...
      <div className="pt-2 relative z-10">
        <h2 className="text-xl font-bold text-[#594246] dark:text-[#f8f0f5]">Productos que puedes reseñar</h2>
        <p className="text-[#594246]/70 dark:text-[#f0d8e8]/70 text-sm mt-1 font-medium">Solo aparecen productos de pedidos ya entregados.</p>
      </div>
      ...
      <div className="space-y-8 relative z-10">
        ...
        {activeTab === 'completed' && (
          <div className="py-20 flex flex-col items-center justify-center text-[#594246]/40 dark:text-[#f8f0f5]/40 bg-white/60 dark:bg-[#2d0a1e]/40 backdrop-blur-sm rounded-3xl border border-[#EBEAE8] dark:border-[#e8688a]/20 shadow-sm">
  ...
  return (
    <div className="bg-white/90 dark:bg-[#2d0a1e]/40 backdrop-blur-sm rounded-3xl shadow-[0_10px_40px_-10px_rgba(89,66,70,0.15)] dark:shadow-[0_8px_32px_rgba(232,104,138,0.15)] border border-[#F2D0D3]/60 dark:border-[#e8688a]/20 p-6 lg:p-8 flex flex-col lg:flex-row gap-8 lg:gap-12 transition-shadow duration-300 hover:shadow-[0_15px_50px_-10px_rgba(89,66,70,0.25)] dark:hover:shadow-[0_12px_40px_-4px_rgba(232,104,138,0.2)] relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Star Rating Section */}
        <div className="mb-6">
          <p className="text-[#632034] dark:text-[#f8f0f5] font-bold text-sm mb-3">Califica este producto</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-auto">
          ...
          {/* Add Photo Button */}
          <button className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-dashed border-[#594246]/30 dark:border-[#e8688a]/30 text-[#632034] dark:text-[#f0a0c0] font-bold hover:bg-[#FAF9F6] dark:hover:bg-[#e8688a]/10 hover:border-[#F2D0D3] dark:hover:border-[#e8688a]/50 hover:text-[#F2778D] dark:hover:text-[#f8f0f5] transition-colors duration-300">
