...
const STATUS_STYLES: Record<string, string> = {
  ...
  EN_TRANSITO: "bg-sky-50 dark:bg-sky-500/10 text-sky-600 dark:text-sky-300 border-sky-100 dark:border-sky-500/20",
                  ...
                  <div className="flex items-center gap-5 relative z-10">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mt-1.5">
                        <p className="text-sm font-medium text-[#8C6B79] dark:text-gray-400 tracking-wide">{srcName} → {tgtName}</p>
