...
export default function RootLayout({
  ...
  return (
    <html lang="es" suppressHydrationWarning>
      ...
      <body className={`min-h-screen flex flex-col overflow-x-hidden bg-background text-foreground transition-colors duration-500 ease-in-out ${montserrat.variable} ${vidaloka.variable} ${inter.variable} ${playfair.variable} ${raleway.variable} ${cormorant.variable}`}>
