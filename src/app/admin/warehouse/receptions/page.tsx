  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
        <div>
          <h1 className="text-4xl md:text-5xl font-bold font-serif text-[#40202D] dark:text-white mb-3 flex items-center gap-3 drop-shadow-md tracking-wide">
            Recepciones 
            <motion.div 
      ...
      <div className="bg-white/90 dark:bg-[#1A0B11]/60 backdrop-blur-2xl border border-[#EAE0E2] dark:border-[#F2778D]/25 rounded-[2.5rem] p-6 md:p-10 shadow-sm">
        
        <h2 className="text-xl md:text-2xl font-bold text-[#40202D] dark:text-white mb-8 flex items-center gap-2 tracking-wide drop-shadow-sm">
          Órdenes entrantes
        </h2>
        ...
        <div className="space-y-5">
          {dummyReceptions.map((rec, i) => (
            <Link 
              ...
              className="group flex flex-col md:flex-row md:items-center justify-between p-5 md:p-6 rounded-[1.5rem] bg-[#FCF8F9] dark:bg-black/30 border border-[#F2DEE4] dark:border-[#F2778D]/15 hover:bg-white dark:hover:bg-black/50 hover:border-[#F2778D]/50 transition-all duration-300 backdrop-blur-md relative overflow-hidden"
            >
              {/* Subtle hover gradient inside card */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#F2778D]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
              ...
              <div className="flex items-center gap-5 relative z-10">
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#40202D] dark:text-white group-hover:text-[#F23B69] dark:group-hover:text-[#F8BBD0] transition-colors tracking-wide">
                    Orden #{rec.id}
                  </h3>
                  <div className="flex items-center gap-3 mt-1.5">
                    ...
                    <p className="text-xs font-bold text-[#AD8997] dark:text-[#C9B3BC] flex items-center gap-1.5 tracking-wide">
              ...
              <div className="flex items-center justify-between md:justify-end gap-8 mt-6 md:mt-0 relative z-10 w-full md:w-auto">
                <div className="text-left md:text-right border-t md:border-t-0 md:border-l border-[#EADCE0] dark:border-[#F2778D]/20 pt-4 md:pt-0 md:pl-8 w-full md:w-auto flex md:flex-col justify-between items-center md:items-end">
                  <span className="text-[11px] font-bold text-[#8C6B79] dark:text-[#F8BBD0]/80 uppercase tracking-widest mb-1.5">
                    Unidades
                  </span>
                ...
                <div className="flex items-center gap-5">
                  <span className={`px-4 py-1.5 rounded-full text-[11px] font-bold tracking-wide shadow-sm border ${
