    ...
    {/* ACORDEÓN DESPLEGABLE */}
      ...
      <>
        <button 
          ...
          className="px-8 py-4 rounded-2xl border border-amber-500/50 bg-amber-50/50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 font-black text-[11px] uppercase tracking-widest flex items-center gap-2 hover:bg-amber-100 dark:hover:bg-amber-500/20 transition-colors shadow-sm"
        >
        ...
        <button 
          ...
          className="px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-400 text-white font-black text-[11px] uppercase tracking-widest flex items-center gap-2 hover:scale-[1.02] transition-all shadow-lg shadow-emerald-500/20"
        >
          <CheckCircle2 className="w-4 h-4" /> Aprobar a Inventario
        </button>
      </>
    )}
