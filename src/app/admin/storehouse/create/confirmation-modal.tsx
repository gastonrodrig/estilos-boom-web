    ...
    >
      <div className="space-y-6">
        ...
        <div className="rounded-[2rem] border border-[#EAE0E2] dark:border-white/10 bg-white/50 dark:bg-black/30 backdrop-blur-md p-6 shadow-sm">
          <p className="text-[11px] font-black uppercase tracking-widest text-[#8C6B79] dark:text-gray-400 mb-4">
          ...
          <div className="overflow-hidden rounded-2xl border border-[#EAE0E2] dark:border-white/10 bg-white/50 dark:bg-black/20 shadow-inner">
            <div className="grid grid-cols-3 border-b border-[#EAE0E2] dark:border-white/10 bg-white/30 dark:bg-white/5 px-4 py-3 text-[10px] font-black uppercase tracking-widest text-[#8C6B79] dark:text-gray-400">
              <span>Talla</span>
              <span>Color</span>
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="h-10 w-full max-w-[100px] rounded-xl border border-[#EAE0E2] dark:border-white/10 bg-white/70 dark:bg-black/30 px-3 text-center text-[13px] font-black text-[#40202D] dark:text-white outline-none focus:ring-2 focus:ring-[#D6405F]/50 shadow-inner transition-all"
                  />
                </div>
              ))}
            </div>

            <div className="grid grid-cols-3 border-t border-[#EAE0E2] dark:border-white/10 bg-gradient-to-r from-[#D6405F]/5 to-[#F23B69]/5 dark:from-[#D6405F]/10 dark:to-[#F23B69]/10 px-4 py-3 text-[13px] font-black text-[#D6405F] dark:text-[#F8BBD0]">
        ...
        <div className="space-y-3">
          <label className="block">
            <span className="mb-2 block text-[10px] font-black uppercase tracking-widest text-[#8C6B79] dark:text-gray-400">
